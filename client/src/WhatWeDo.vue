      ...
      <div class="col bg-grey-black">
        <div class="container">
          <div class="row justify-content-md-center align-items-center full-height">
            <div class="col-sm-12 col-md-10 col-lg-10 text-light text-center d-none d-sm-none d-md-block">
            ...
            <div class="col-sm-12 col-md-10 col-lg-10 text-light text-center d-block d-md-none">
              <h4 class="font-weight-light">C230 Consultores</h4>
              <h3 class="font-weight-bold">¿Quiénes somos?</h3>
              <img src="/img/whatwedo/svg/hexagon.svg" alt="hexagon" style="width:40%;">
              <p class="font-weight-light">
                Generamos insumos para apoyar la toma de decisiones de nuestros clientes.
              </p>
              <img src="/img/whatwedo/svg/circles.svg" alt="circles" style="width:40%;">
              <p class="font-weight-light">
                Ayudamos a resolver problemas
              </p>
              <img src="/img/whatwedo/svg/triangle.svg" alt="triangle" style="width:40%;">
              <p class="font-weight-light">
                Añadimos valor al trabajo de nuestros clientes.
              </p>
            </div>
